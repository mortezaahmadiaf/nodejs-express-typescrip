...
exports.accessDenied = exports.mongoError = exports.insufficientParameters = exports.failureResponse = exports.successResponse = void 0;
...
function accessDenied(err, res) {
    res.status(model_1.response_status_codes.acced_denied).json({
        STATUS: 'UNAUTHORIZE',
